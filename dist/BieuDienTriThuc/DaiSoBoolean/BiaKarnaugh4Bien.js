...
exports.BiaKarNaugh4Bien = void 0;
const BiaKarnaugh_1 = require("./BiaKarnaugh");
class BiaKarNaugh4Bien extends BiaKarnaugh_1.BiaKarnaugh {
    ...
    teBao8() {
        ...
        for (let i = 0; i < this.KarNaugh.length - 1; i++) {
            if (this.KarNaugh[i][0] === -1)
                continue;
            if (this.KarNaugh[i][0] === -1 || this.KarNaugh[i][1] === -1 || this.KarNaugh[i][2] === -1 || this.KarNaugh[i][3] === -1)
                continue;
            if (this.KarNaugh[i + 1][0] === -1 || this.KarNaugh[i + 1][1] === -1 || this.KarNaugh[i + 1][2] === -1 || this.KarNaugh[i + 1][3] === -1)
                continue;
            let m = new Array();
            for (let j = 0; j < 2; j++) {
                for (let z = 0; z < 4; z++)
        ...
        for (let i = 0; i < this.KarNaugh.length - 1; i++) {
            if (this.KarNaugh[0][i] === -1)
                continue;
            if (this.KarNaugh[0][i] === -1 || this.KarNaugh[1][i] === -1 || this.KarNaugh[2][i] === -1 || this.KarNaugh[3][i] === -1)
                continue;
            if (this.KarNaugh[0][i + 1] === -1 || this.KarNaugh[1][i + 1] === -1 || this.KarNaugh[2][i + 1] === -1 || this.KarNaugh[3][i + 1] === -1)
                continue;
            let m = new Array();
            for (let j = 0; j < 2; j++) {
                for (let z = 0; z < 4; z++)
    ...
    teBao4() {
        ...
        for (let i = 0; i < this.KarNaugh.length; i++) {
            if (this.KarNaugh[0][i] === -1 || this.KarNaugh[1][i] === -1 || this.KarNaugh[2][i] === -1 || this.KarNaugh[3][i] === -1)
                continue;
            let m = [this.KarNaugh[0][i], this.KarNaugh[1][i], this.KarNaugh[2][i], this.KarNaugh[3][i]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
        ...
        for (let i = 0; i < this.KarNaugh.length - 1; i++) {
            for (let j = 0; j < this.KarNaugh[0].length - 1; j++) {
                if (this.KarNaugh[i][j] === -1)
                    continue;
                if (this.KarNaugh[i][j + 1] === -1 || this.KarNaugh[i][j + 1] === -1 || this.KarNaugh[i + 1][j] === -1 || this.KarNaugh[i + 1][j + 1] === -1)
                    continue;
                let m = [this.KarNaugh[i][j], this.KarNaugh[i][j + 1], this.KarNaugh[i + 1][j], this.KarNaugh[i + 1][j + 1]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
        ...
        if (this.KarNaugh[0][0] !== -1 && this.KarNaugh[0][3] !== -1 && this.KarNaugh[3][0] !== -1 && this.KarNaugh[3][3] !== -1) {
            let m = [this.KarNaugh[0][0], this.KarNaugh[0][3], this.KarNaugh[3][0], this.KarNaugh[3][3]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
        ...
        for (let i = 0; i < this.KarNaugh.length - 1; i++) {
            if (this.KarNaugh[0][i] === -1)
                continue;
            if (this.KarNaugh[0][i] === -1 || this.KarNaugh[0][i + 1] === -1 || this.KarNaugh[3][i] === -1 || this.KarNaugh[3][i + 1] === -1)
                continue;
            let m = [this.KarNaugh[0][i], this.KarNaugh[0][i + 1], this.KarNaugh[3][i], this.KarNaugh[3][i + 1]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
        ...
        for (let i = 0; i < this.KarNaugh.length - 1; i++) {
            if (this.KarNaugh[i][0] === -1)
                continue;
            if (this.KarNaugh[i][0] === -1 || this.KarNaugh[i + 1][0] === -1 || this.KarNaugh[i][3] === -1 || this.KarNaugh[i + 1][3] === -1)
                continue;
            let m = [this.KarNaugh[i][0], this.KarNaugh[i + 1][0], this.KarNaugh[i][3], this.KarNaugh[i + 1][3]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
    ...
    teBao2() {
        ...
        for (let i = 0; i < this.KarNaugh.length; i++) {
            if (this.KarNaugh[0][i] === -1 || this.KarNaugh[3][i] === -1)
                continue;
            let m = [this.KarNaugh[0][i], this.KarNaugh[3][i]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
...
exports.BiaKarNaugh4Bien = BiaKarNaugh4Bien;
