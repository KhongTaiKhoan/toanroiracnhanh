...
export class BiaKarNaugh5Bien extends BiaKarnaugh{
    ...
    teBao16(): NhomTeBao | null {
        ...
        for (let index = 0; index < this.KarNaugh.length; index++) {
            ...
            for (let i = 0; i < this.KarNaugh[index].length; i++) {
                for (let j = 0; j < this.KarNaugh[index][i].length; j++) {
                    if (this.KarNaugh[index][i][j] === -1) { hl = false; break; }
                }
                if (!hl) break;
            }
            if (hl) {
        ...
        for (let i = 0; i < this.KarNaugh[0].length - 1; i++) {
            if (this.KarNaugh[0][i][0] === -1) continue;
            if (this.KarNaugh[0][i][0] === -1 || this.KarNaugh[0][i][1] === -1 || this.KarNaugh[0][i][2] === -1 || this.KarNaugh[0][i][3] === -1) continue;
            if (this.KarNaugh[0][i + 1][0] === -1 || this.KarNaugh[0][i + 1][1] === -1 || this.KarNaugh[0][i + 1][2] === -1 || this.KarNaugh[0][i + 1][3] === -1) continue;
            
            if (this.KarNaugh[1][i][0] === -1 || this.KarNaugh[1][i][1] === -1 || this.KarNaugh[1][i][2] === -1 || this.KarNaugh[1][i][3] === -1) continue;
            if (this.KarNaugh[1][i + 1][0] === -1 || this.KarNaugh[1][i + 1][1] === -1 || this.KarNaugh[1][i + 1][2] === -1 || this.KarNaugh[1][i + 1][3] === -1) continue;
        ...
        for (let i = 0; i < this.KarNaugh[0].length - 1; i++) {
            if (this.KarNaugh[0][0][i] === -1) continue;
            if (this.KarNaugh[0][0][i] === -1 || this.KarNaugh[0][1][i] === -1 || this.KarNaugh[0][2][i] === -1 || this.KarNaugh[0][3][i] === -1) continue;
            if (this.KarNaugh[0][0][i + 1] === -1 || this.KarNaugh[0][1][i + 1] === -1 || this.KarNaugh[0][2][i + 1] === -1 || this.KarNaugh[0][3][i + 1] === -1) continue;
          
            if (this.KarNaugh[1][0][i] === -1 || this.KarNaugh[1][1][i] === -1 || this.KarNaugh[1][2][i] === -1 || this.KarNaugh[1][3][i] === -1) continue;
            if (this.KarNaugh[1][0][i + 1] === -1 || this.KarNaugh[1][1][i + 1] === -1 || this.KarNaugh[1][2][i + 1] === -1 || this.KarNaugh[1][3][i + 1] === -1) continue;
    ...
    teBao8(): NhomTeBao | null {
        ...
        for (let index = 0; index < this.KarNaugh.length; index++) {
            ...
            for (let i = 0; i < this.KarNaugh[index].length - 1; i++) {
                if (this.KarNaugh[index][i][0] === -1) continue;
                if (this.KarNaugh[index][i][0] === -1 || this.KarNaugh[index][i][1] === -1 || this.KarNaugh[index][i][2] === -1 || this.KarNaugh[index][i][3] === -1) continue;
                if (this.KarNaugh[index][i + 1][0] === -1 || this.KarNaugh[index][i + 1][1] === -1 || this.KarNaugh[index][i + 1][2] === -1 || this.KarNaugh[index][i + 1][3] === -1) continue;
            ...
            /// KIEM TRA COT
            for (let i = 0; i < this.KarNaugh[index].length - 1; i++) {
                if (this.KarNaugh[index][0][i] === -1) continue;
                if (this.KarNaugh[index][0][i] === -1 || this.KarNaugh[index][1][i] === -1 || this.KarNaugh[index][2][i] === -1 || this.KarNaugh[index][3][i] === -1) continue;
                if (this.KarNaugh[index][0][i + 1] === -1 || this.KarNaugh[index][1][i + 1] === -1 || this.KarNaugh[index][2][i + 1] === -1 || this.KarNaugh[index][3][i + 1] === -1) continue;
        ...
        for (let i = 0; i < this.KarNaugh[0].length; i++) {
            if (this.KarNaugh[0][0][i] === -1 || this.KarNaugh[0][1][i] === -1 || this.KarNaugh[0][2][i] === -1 || this.KarNaugh[0][3][i] === -1) continue;
            if (this.KarNaugh[1][0][i] === -1 || this.KarNaugh[1][1][i] === -1 || this.KarNaugh[1][2][i] === -1 || this.KarNaugh[1][3][i] === -1) continue;
            let m: number[] = [this.KarNaugh[0][0][i], this.KarNaugh[0][1][i], this.KarNaugh[0][2][i], this.KarNaugh[0][3][i],
        ...
        for (let i = 0; i < this.KarNaugh[0].length - 1; i++) {
            for (let j = 0; j < this.KarNaugh[0].length - 1; j++) {
                if (this.KarNaugh[0][i][j] === -1) continue;
                if (this.KarNaugh[0][i][j + 1] === -1 || this.KarNaugh[0][i][j + 1] === -1 || this.KarNaugh[0][i + 1][j] === -1 || this.KarNaugh[0][i + 1][j + 1] === -1) continue;
                if (this.KarNaugh[1][i][j + 1] === -1 || this.KarNaugh[1][i][j + 1] === -1 || this.KarNaugh[1][i + 1][j] === -1 || this.KarNaugh[1][i + 1][j + 1] === -1) continue;
                let m: number[] = [this.KarNaugh[0][i][j], this.KarNaugh[0][i][j + 1], this.KarNaugh[0][i + 1][j], this.KarNaugh[0][i + 1][j + 1],
        ...
        if (this.KarNaugh[0][0][0] !== -1 && this.KarNaugh[0][0][3] !== -1 && this.KarNaugh[0][3][0] !== -1 && this.KarNaugh[0][3][3] !== -1) {
            ...
            let m: number[] = [this.KarNaugh[0][0][0], this.KarNaugh[0][0][3], this.KarNaugh[0][3][0], this.KarNaugh[0][3][3],
        ...
        for (let i = 0; i < this.KarNaugh[0].length-1; i++) {
            if (this.KarNaugh[0][0][i] === -1) continue;
            if (this.KarNaugh[0][0][i] === -1 || this.KarNaugh[0][0][i + 1] === -1 || this.KarNaugh[0][3][i] === -1 || this.KarNaugh[0][3][i + 1] === -1) continue;
            if (this.KarNaugh[1][0][i] === -1 || this.KarNaugh[1][0][i + 1] === -1 || this.KarNaugh[1][3][i] === -1 || this.KarNaugh[1][3][i + 1] === -1) continue;
            let m: number[] = [this.KarNaugh[0][0][i], this.KarNaugh[0][0][i + 1], this.KarNaugh[0][3][i], this.KarNaugh[0][3][i + 1],
        ...
        for (let i = 0; i < this.KarNaugh[0].length-1; i++) {
            if (this.KarNaugh[0][i][0] === -1) continue;
            if (this.KarNaugh[0][i][0] === -1 || this.KarNaugh[0][i + 1][0] === -1 || this.KarNaugh[0][i][3] === -1 || this.KarNaugh[0][i + 1][3] === -1) continue;
            if (this.KarNaugh[1][i][0] === -1 || this.KarNaugh[1][i + 1][0] === -1 || this.KarNaugh[1][i][3] === -1 || this.KarNaugh[1][i + 1][3] === -1) continue;
            let m: number[] = [this.KarNaugh[0][i][0], this.KarNaugh[0][i + 1][0], this.KarNaugh[0][i][3], this.KarNaugh[0][i + 1][3],
    ...
    teBao4(): NhomTeBao | null {
        ...
        for (let index = 0; index < this.KarNaugh.length; index++) {
            ...
            for (let i = 0; i < this.KarNaugh.length; i++) {
                if (this.KarNaugh[index][0][i] === -1 || this.KarNaugh[index][1][i] === -1 || this.KarNaugh[index][2][i] === -1 || this.KarNaugh[index][3][i] === -1) continue;
                let m: number[] = [this.KarNaugh[index][0][i], this.KarNaugh[index][1][i], this.KarNaugh[index][2][i], this.KarNaugh[index][3][i]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
            ...
            for (let i = 0; i < this.KarNaugh.length - 1; i++) {
                for (let j = 0; j < this.KarNaugh[0].length - 1; j++) {
                    if (this.KarNaugh[index][i][j] === -1) continue;
                    if (this.KarNaugh[index][i][j + 1] === -1 || this.KarNaugh[index][i][j + 1] === -1 || this.KarNaugh[index][i + 1][j] === -1 || this.KarNaugh[index][i + 1][j + 1] === -1) continue;
                    let m: number[] = [this.KarNaugh[index][i][j], this.KarNaugh[index][i][j + 1], this.KarNaugh[index][i + 1][j], this.KarNaugh[index][i + 1][j + 1]];
                    if (this.kiemTraChuaDung(m)) {
                        rs.push(m);
                    }
                }
            ...
            if (this.KarNaugh[index][0][0] !== -1 && this.KarNaugh[index][0][3] !== -1 && this.KarNaugh[index][3][0] !== -1 && this.KarNaugh[index][3][3] !== -1) {
                let m: number[] = [this.KarNaugh[index][0][0], this.KarNaugh[index][0][3], this.KarNaugh[index][3][0], this.KarNaugh[index][3][3]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
            ...
            for (let i = 0; i < this.KarNaugh[index].length - 1; i++) {
                if (this.KarNaugh[index][0][i] === -1) continue;
                if (this.KarNaugh[index][0][i] === -1 || this.KarNaugh[index][0][i + 1] === -1 || this.KarNaugh[index][3][i] === -1 || this.KarNaugh[index][3][i + 1] === -1) continue;
                let m: number[] = [this.KarNaugh[index][0][i], this.KarNaugh[index][0][i + 1], this.KarNaugh[index][3][i], this.KarNaugh[index][3][i + 1]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
            ...
            for (let i = 0; i < this.KarNaugh[index].length - 1; i++) {
                if (this.KarNaugh[index][i][0] === -1) continue;
                if (this.KarNaugh[index][i][0] === -1 || this.KarNaugh[index][i + 1][0] === -1 || this.KarNaugh[index][i][3] === -1 || this.KarNaugh[index][i + 1][3] === -1) continue;
                let m: number[] = [this.KarNaugh[index][i][0], this.KarNaugh[index][i + 1][0], this.KarNaugh[index][i][3], this.KarNaugh[index][i + 1][3]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
        ...
        for (let i = 0; i < this.KarNaugh[0].length - 1; i++) {
            for (let j = 0; j < this.KarNaugh[0][0].length - 1; j++) {
                ...
                if (j < this.KarNaugh[0][i].length-1 && (this.KarNaugh[0][i][j] !== -1 && this.KarNaugh[0][i][j + 1] !== -1 && this.KarNaugh[1][i][j] !== -1 && this.KarNaugh[1][i][j + 1] !== -1)) {
                    let m: number[] = [this.KarNaugh[0][i][j], this.KarNaugh[0][i][j + 1],this.KarNaugh[1][i][j], this.KarNaugh[1][i][j + 1]];
                    if (this.kiemTraChuaDung(m)) {
                        rs.push(m);
                    }
                }
                ...
                if (i < this.KarNaugh[0].length-1 && (this.KarNaugh[0][i][j] !== -1 && this.KarNaugh[0][i + 1][j] !== -1 && this.KarNaugh[1][i][j] !== -1 && this.KarNaugh[1][i + 1][j] !== -1)) {
                    let m: number[] = [this.KarNaugh[0][i + 1][j], this.KarNaugh[0][i][j],this.KarNaugh[1][i + 1][j], this.KarNaugh[1][i][j]];
                    if (this.kiemTraChuaDung(m)) {
                        rs.push(m);
                    }
                }
        ...
        for (let i = 0; i < this.KarNaugh[0].length; i++) {
            if (this.KarNaugh[0][0][i] === -1 || this.KarNaugh[0][3][i] === -1) continue;
            if (this.KarNaugh[1][0][i] === -1 || this.KarNaugh[1][3][i] === -1) continue;
            let m: number[] = [this.KarNaugh[0][0][i], this.KarNaugh[0][3][i],this.KarNaugh[1][0][i], this.KarNaugh[1][3][i]];
            if (this.kiemTraChuaDung(m)) {
                rs.push(m);
            }
        }
        ...
        for (let i = 0; i < this.KarNaugh[0].length; i++) {
            if (this.KarNaugh[0][i][0] === -1 || this.KarNaugh[0][i][3] === -1) continue;
            if (this.KarNaugh[1][i][0] === -1 || this.KarNaugh[1][i][3] === -1) continue;
            let m: number[] = [this.KarNaugh[0][i][0], this.KarNaugh[0][i][3],this.KarNaugh[1][i][0], this.KarNaugh[1][i][3]];
            if (this.kiemTraChuaDung( m)) {
                rs.push(m);
            }
        } 
    ...
    teBao2(): NhomTeBao | null {
       let rs: number[][] = [];
        ...
        for (let index = 0; index < this.KarNaugh.length; index++) {
            ...
            for (let i = 0; i < this.KarNaugh[index].length ; i++) {
                for (let j = 0; j < this.KarNaugh[index][0].length ; j++) {
                    ...
                    if (j < this.KarNaugh[index][i].length-1 && (this.KarNaugh[index][i][j] !== -1 && this.KarNaugh[index][i][j + 1] !== -1)) {
                        let m: number[] = [this.KarNaugh[index][i][j], this.KarNaugh[index][i][j + 1]];
                        if (this.kiemTraChuaDung(m)) {
                            rs.push(m);
                        }
                    }
                    ...
                    if (i < this.KarNaugh[index].length-1 && (this.KarNaugh[index][i][j] !== -1 && this.KarNaugh[index][i + 1][j] !== -1)) {
                        let m: number[] = [this.KarNaugh[index][i + 1][j], this.KarNaugh[index][i][j]];
                        if (this.kiemTraChuaDung(m)) {
                            rs.push(m);
                        }
                    }
            ...
            //// KIEM TRA DOI XUNG BIEN NGANG
            for (let i = 0; i < this.KarNaugh[index].length; i++) {
                if (this.KarNaugh[index][0][i] === -1 || this.KarNaugh[index][3][i] === -1) continue;
                let m: number[] = [this.KarNaugh[index][0][i], this.KarNaugh[index][3][i]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
            //// KIEM TRA DOI XUNG BIEN THANG
            for (let i = 0; i < this.KarNaugh[index].length; i++) {
                if (this.KarNaugh[index][i][0] === -1 || this.KarNaugh[index][i][3] === -1) continue;
                let m: number[] = [this.KarNaugh[index][i][0], this.KarNaugh[index][i][3]];
                if (this.kiemTraChuaDung(m)) {
                    rs.push(m);
                }
            }
        ...
        for (let i = 0; i < this.KarNaugh[0].length; i++) {
            for (let j = 0; j < this.KarNaugh[0][i].length; j++) {
                if(this.KarNaugh[0][i][j] === -1) continue;
                if(this.KarNaugh[1][i][j] === -1) continue;
                let m:number[]=[this.KarNaugh[0][i][j] ,this.KarNaugh[1][i][j] ];
                if(this.kiemTraChuaDung(m))
                rs.push(m);
            }             
        }
        ...
        for (let index = 0; index < this.KarNaugh.length; index++) {
            for (let i = 0; i < this.KarNaugh[index].length; i++) {
                for (let j = 0; j < this.KarNaugh[index][i].length; j++) {
                    ...
                    if (!b) m.push(this.KarNaugh[index][i][j]);
                }
            }
